...
| Desktop actions | Capture/record/open actions in Spectacle desktop file | Install a Toolbelt-owned guide launcher and service menus until native actions are useful | Add native scrolling action to Spectacle desktop file |
