...
| Desktop actions | Capture/record/open actions in Spectacle desktop file | Install Toolbelt-owned launchers and service menus only | Add native scrolling action to Spectacle desktop file |
